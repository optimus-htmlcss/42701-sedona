...
* Студент: [Студентище Неопознанный 2](http://up.htmlacademy.local/htmlcss/20/user/42701).
* Наставник: Наставник Неопознанный`.
...
[Откройте мастер-репозиторий](https://github.com/optimus-htmlcss/42701-sedona) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
